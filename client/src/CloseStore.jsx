...
class CloseStore extends Component {
    ...
    handleOnClick = (event) => {
        const txStackId = this.props.closeStore.cacheSend();
        ...
        return (
            <div className="card shadow text-white bg-danger text-center">
                ...
                <span className="card-body small">
                    Permanently close the store, allowing only customer refunds. Settled and excess
                    balances are transferred to owner.
                </span>
